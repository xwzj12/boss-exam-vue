...
export default {
  ...
  created () {
    ...
    this.$ajax.post(
      '/gateway/paper/goMaintainpaperController',
      {
        head: {
          version: '1',
  ...
  methods: {
    ...
    handleSelect () {
      this.$ajax.post(
        '/gateway/paper/maintainpaperHandleSelect',
        {
          head: {
            version: '1',
            token: this.getCookie(),
    ...
    forbidden (index, row) {
      this.$ajax.post(
        '/gateway/paper/forbiddenController',
        {
          head: {
            version: '1',
            token: this.getCookie(),
    ...
    startUp (index, row) {
      this.$ajax.post(
        '/gateway/paper/startUpController',
        {
          head: {
            version: '1',
            token: this.getCookie(),
