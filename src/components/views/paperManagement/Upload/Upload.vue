      ...
      <div class="table">
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column label="状态" width="180">
            <template slot-scope="scope">
              <el-tag v-if="scope.row.template == '1'" size="medium" effect="plain">已上传</el-tag>
              <el-tag v-if="scope.row.template == '0'" type="info" size="medium" effect="plain">未上传</el-tag>
            </template>
          </el-table-column>
...
export default {
  ...
  created () {
    ...
    this.$ajax.post(
      '/gateway/paper/goUploadController',
      {
        head: {
          version: '1',
  ...
  methods: {
    ...
    handleCurrentChange (val) {
      ...
      this.$ajax.post(
        '/gateway/paper/handleCurrentChange',
        {
          head: {
            version: '1',
            token: this.getCookie(),
