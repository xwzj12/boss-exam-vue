<template>
    <div id="all">
        <div id="left">
            <card title="角色管理" :dataTree="dataTree" />
        </div>
...
import stable from '../../common/SystemManagement/SystemManagementTables/SystemRoleTable';
  ...
  export default {
    ...
    methods: {
      getdataTree(){
         this.$ajax.post(
      'gateway/systemModule/doQueryCompanyRoleTree',
      {
        
