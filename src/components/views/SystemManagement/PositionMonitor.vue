<template>
    <div id="all">
        <div id="left">
            <card title="职位管理" :dataTree="dataTree" />
        </div>
...
import stable from '../../common/SystemManagement/SystemManagementTables/SystemPositionTable';
  ...
  export default {
    ...
    methods: {
      getdataTree(){
         this.$ajax.post(
      'gateway/systemModule/doQueryPositionNameTreeByCompanyId',
      {
        
