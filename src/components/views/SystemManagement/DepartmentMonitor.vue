<template>
    <div id="all">
        <div id="left">
            <card title="部门管理" :dataTree="dataTree"/>
        </div>
...
import stable from '../../common/SystemManagement/SystemManagementTables/SystemDepartmentTable';
  ...
  export default {
    ...
    methods: {
      getdataTree(){
         this.$ajax.post(
      'gateway/systemModule/doQueryDepartmentNameTreeByCompanyId',
      {
        
