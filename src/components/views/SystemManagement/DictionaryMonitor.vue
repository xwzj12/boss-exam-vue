<template>
    <div id="all">
        <div id="left">
            <!-- <card title="字典管理" :dataTree="dataTree" /> -->
        </div>
...
import stable from '../../common/SystemManagement/SystemManagementTables/SystemDictionaryTable';
  ...
  export default {
    ...
    methods: {
      getdataTree(){
         this.$ajax.post(
      'gateway/systemModule/doQuerySystemParamTypeByOrgId',
      {
        
