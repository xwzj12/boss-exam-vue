<template>
    <div id="all">
        <div id="left">
            <card title="参数管理" :dataTree="dataTree" />
        </div>
...
import stable from '../../common/SystemManagement/SystemManagementTables/SystemParamTable';
  ...
  export default {
    ...
    methods: {
      getdataTree(){
         this.$ajax.post(
      'gateway/systemModule/doQueryDictionaryForSystemParamTypeTreeByOrgId',
      {
        
